...
class StoredProcedureStore
{
     ...
     * @throws \Exception
     */
    public static function instance($procedure, DbDriver $driver, ProcedureDataFormatter $dataFormatter, $parameters = [])
    {
        ...
        $procedure = new $procedure($driver, $dataFormatter, $parameters);
